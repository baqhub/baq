export const metadata = {
  ...
  title: "Welcome BAQ",
  subTitle: "Build apps faster, keep users in control",
  description:
    "Today marks the release of BAQ, a new set of tools and protocols to build federated apps that enables developers to build faster while keeping users in control of their data.",
  image: "blog01",
};
