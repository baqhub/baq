...
We're now done adding interactivity to our components. It's expected for the app not to work at this point as we need to add authentication before we can start using it.
