...
- **Let all data be social**. With the flick of a switch, any piece of data can be shared with close friends, or with everyone else in the world! Build social apps just like any other app, at no extra cost to developers.
