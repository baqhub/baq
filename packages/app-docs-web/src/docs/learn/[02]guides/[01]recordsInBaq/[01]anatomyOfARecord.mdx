...
See the [record reference](01735953) for more technical information.
...
Some types are built-in to implement some of the protocol [core features](ab269c26), but anyone can create and publish their own types to best represent the data model needed for their apps.
