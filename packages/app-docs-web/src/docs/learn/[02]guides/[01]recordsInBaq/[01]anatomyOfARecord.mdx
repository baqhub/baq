...
Some types are built-in to implement some of the platform [core features](ab269c26), but anyone can create and publish their own types to best represent the data model needed for their apps.
