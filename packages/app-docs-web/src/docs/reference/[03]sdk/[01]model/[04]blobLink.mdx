...
Once created, a blob link can immediately be used in the content of a record that accepts a link of the same type. In this example, we upload a [`File`](https://developer.mozilla.org/en-US/docs/Web/API/File) and create a [File record](/todo).
