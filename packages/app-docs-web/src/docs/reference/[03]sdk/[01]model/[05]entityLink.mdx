...
Once created, an entity link can be used in the content of a record. In this example we create a [Post record](d1f9da17#post) that mentions other users with the help of entity links.
