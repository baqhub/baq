...
- **`client`** <props.pill href="/todo">Client</props.pill>
...
- **<props.code>findRecordByQuery\<T\>(query: <props.pill href="/todo">RecordQuery\<T\></props.pill>)</props.code>**: <props.pill>T | undefined</props.pill>
...
- **<props.code>buildBlobUrl(record: <props.pill href="/todo">Record</props.pill>, blob: <props.pill href="/todo">BlobLink</props.pill>, expIn?: <props.pill>number</props.pill>)</props.code>**: <props.pill>string</props.pill>
